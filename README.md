...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/ejohnpaul/k8s-metrics-server.git  and run the commands below:
 
```console
# clone manifest repo
git clone https://github.com/ejohnpaul/k8s-metrics-server.git
# deploy metricAPI
